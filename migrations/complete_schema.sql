-- Complete Schema - Updated with all columns from old database
...
-- Wallet transactions with all columns
...
-- KYC submissions with all columns
...
-- Employment packages with all columns
...
-- Email templates with all columns
...
-- Platform settings with all columns
...
-- Job applications with all columns
...
-- Ticket messages with all columns
...
-- Salary disbursements with all columns
