...
DROP TYPE IF EXISTS public.app_role AS ENUM (
    'admin',
    'employee'
);
...
DROP TYPE IF EXISTS public.application_status AS ENUM (
    'pending',
    'approved',
    'rejected'
);
...
DROP TYPE IF EXISTS public.disbursement_status AS ENUM (
    'pending',
    'held',
    'paid',
    'cancelled'
...
DROP TYPE IF EXISTS public.kyc_status AS ENUM (
    'not_started',
    'fee_pending',
    'fee_paid',
    'payment_submitted',
...
DROP TYPE IF EXISTS public.module_status AS ENUM (
    'todo',
    'in_progress',
    'review',
    'done'
...
DROP TYPE IF EXISTS public.project_role AS ENUM (
    'lead',
    'member',
    'viewer'
);
...
DROP TYPE IF EXISTS public.project_status AS ENUM (
    'planning',
    'active',
    'on_hold',
    'completed',
...
DROP TYPE IF EXISTS public.task_priority AS ENUM (
    'low',
    'medium',
    'high',
    'urgent'
...
DROP TYPE IF EXISTS public.task_status AS ENUM (
    'assigned',
    'in_progress',
    'submitted',
    'approved',
...
DROP TYPE IF EXISTS public.ticket_category AS ENUM (
    'kyc',
    'payment',
    'task',
    'general'
...
DROP TYPE IF EXISTS public.ticket_status AS ENUM (
    'open',
    'in_progress',
    'resolved',
    'closed'
...
DROP TYPE IF EXISTS public.withdrawal_status AS ENUM (
    'pending',
    'approved',
    'paid',
    'rejected'
